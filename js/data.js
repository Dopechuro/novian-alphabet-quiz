...
export const rawStoryData = {
    ...
    "DatingCharacterEvent.103303.7": "At the student cafeteria, you and Amber experienced the infamous \"ladle technique\". Your heartbeats rushed with each swing of the ladle.\n\nWhy is it that even in the cafeteria, what you see is never what you get?",
    ...
    "DatingCharacterEvent.110301.1": "\"Honestly, I'm pretty surprised,\" says Firenze, with amused curiosity.\n\"By what?\"\n\"The place you picked. I thought you'd go for something like the library... Do you see me more as a foodie than a good student?\"",
    "DatingCharacterEvent.110301.2": "\"No, come on!\" you reply. \"It's just because I can totally tell that you were an excellent student, and I want to know the other parts of your life.\"\n\"So you're curious about my favorite food and stuff? Heh, you're pretty nosy.\"",
    "DatingCharacterEvent.110301.3": "Firenze is teasing you, but she seems to be actually very pleased.\nShe happily shows you around the cafeteria and buys you a student meal. She shares some nostalgic memories as the food takes her back to her school days.",
    "DatingCharacterEvent.110301.5": "School Days",
    "DatingCharacterEvent.110301.6": "Visit the Academy to unlock",
    "DatingCharacterEvent.110301.7": "Firenze is surprised by your choice.\n\nYou may want a little something to eat, yes, but you also sincerely want to learn more about her mysterious past.\n\nFirenze accepts your suggestion and shares with you her school days.",
    "DatingCharacterEvent.110302.1": "You've spent the whole day exploring the port with Firenze. As dusk falls, she asks if you want to go fishing. That surprises you.\n\"Yeah, I know. Fishing is for those with a lot of time on their hands, and I'm always busy,\" she says, smiling. \"But I hear that it builds character. Since we're here, I'd like to try it.\"",
    "DatingCharacterEvent.110302.2": "Like Firenze said, she's not fishing to catch some fish, so she stays calm and relaxed even when no fish takes the bait for quite some time...\nUntil her competitive side takes over.\n\"How dare you ignore me, fish?\" She also hates to fail.",
    "DatingCharacterEvent.110302.3": "Firenze scatters some United Harvest's special bait onto the water. Soon, lots of fish start to swarm around you.\n\"Yeah, that feels good.\"\nShe's pleased with her bountiful catch, but you can only manage a wry smile.",
    "DatingCharacterEvent.110302.5": "The Bait",
    "DatingCharacterEvent.110302.6": "Visit the Port to unlock",
    "DatingCharacterEvent.110302.7": "Firenze suddenly becomes interested in fishing, saying that it builds character, and asks you to go night fishing.\n\nHowever, after not catching any fish for a while, she loses her patience and uses some special bait. She's no quitter.\n\nAnd you, naturally, join her endeavor.",
    ...
    "DatingCharacterEvent.127301.7": "While exploring the cave with Teresa, you got cut by some gravel. Teresa immediately tended to your wound.\n\nWhat should have been a painful experience turned out surprisingly gentle thanks to her practiced care.",
    ...
    "DatingCharacterEvent.127302.7": "After exploring the market with Teresa, you exchanged gifts. As you had expected, you both ended up getting band-aids for each other.\n\nLife is full of bumps and scrapes, but thankfully we can bandage each and every one of them.",
    "DatingCharacterEvent.130301.1": "As you passed the game stalls at the market, you noticed one of the prizes on display: a cute little teddy bear.\n\nJust then, Donna suddenly leaned closer and asked, \"Hey Boss, do you like that one? If you do, I can win it for you!\"\n\nBefore you could say no, Donna had already picked up the bow and arrows from the stall.\n\n\"Just watch. Archery is my specialty!\"",
    "DatingCharacterEvent.130301.2": "Something strange happened. No matter how many times Donna's arrows hit the teddy bear, it remained firmly seated on the wooden board. You began to suspect something was wrong.\n\n\"Is that bear ... fixed to the board?\"\n\n\"So this is just a scam?!\"\n\nThe stall owner's eyes darted away, but he still insisted that Donna had only failed because her archery wasn't good enough.",
    "DatingCharacterEvent.130301.3": "You were about to speak up for Donna when she drew the bow again, pulling the string taut. This time she didn't aim at the teddy bear but at the pillar beside it. The arrow struck the pillar, ricocheted, and hit the bear from the side, knocking it over.\n\nAs it fell, the back plate fixing it in place came into view.\n\nIn the end, the stall owner was taken away by the Trekker Association for operating in violation of regulations. You walked away with a plush teddy bear and Donna's triumphant grin.",
    "DatingCharacterEvent.130301.5": "The Teddy Bear",
    "DatingCharacterEvent.130301.6": "Visit the Market to unlock",
    "DatingCharacterEvent.130301.7": "You took the teddy bear.\n\nBut you didn't tell Donna that the real reason you looked twice was that it looked a little like her.",
    "DatingCharacterEvent.130302.1": "Beside the library front desk sits a basket stuffed with uncollected letters.\n\nAs you two walk by, Donna sighs: \"Some of these may never reach the people they were meant for.\"",
    "DatingCharacterEvent.130302.2": "\"This one, and this one.\" She picks up two letters from the top. \"I delivered these.\"\n\nShe flips further down—the postmarks show they're years old. \"Their recipients must have graduated by now.\"",
    "DatingCharacterEvent.130302.3": "At the very bottom, one envelope doesn't even have a postmark. Its faded handwriting on yellowed paper looks like a love letter, nearly impossible to read.\nDonna murmurs, \"Some words... You have to say them before they fade away.\"",
    "DatingCharacterEvent.130302.5": "Old Letters",
    "DatingCharacterEvent.130302.6": "Visit the Academy to unlock",
    "DatingCharacterEvent.130302.7": "You and Donna found a pile of forgotten letters in the library. Messages left behind and buried by time.",
    ...
    "DatingCharacterEvent.133301.1": "You and Nazuka were strolling through the Market when you noticed a shady-looking merchant in a dim corner. He was wrapped all in black, and his stall was also covered with a dark cloth.\n\"He's giving off a very suspicious vibe,\" Nazuka remarked.",
    "DatingCharacterEvent.133301.2": "Anyone else might have thought \"better not get involved\" and walked away, but Nazuka clearly wasn't the type.\nBefore approaching, she glanced at you, a hint of hesitation in her eyes.\n\"I'll go with you,\" you said firmly.\nTogether, you stepped up to the stall and lifted the cloth...\nBeneath it gleamed rows of cold, sharp weapons.",
    "DatingCharacterEvent.133301.3": "You got a scare, but Nazuka remained calm.\n\"These are ... replicas. They are safe.\" She crouched down, examining each one before reaching her conclusion.\n\"Y-Yes, just toys,\" the merchant complained, \"but they look so real that no one wants to buy them... I had to set up here in the corner to avoid drawing attention.\"\nA false alarm, thankfully.",
    "DatingCharacterEvent.133301.5": "False Alarm",
    "DatingCharacterEvent.133301.6": "Visit the Market to unlock",
    "DatingCharacterEvent.133301.7": "You and Nazuka explored the Market and spotted a shady merchant.\n\nWhen you both checked his stall and lifted the cover, you found piles of weapons...\n\nHowever, after closer inspection, they turned out to be nothing more than realistic toys.",
    "DatingCharacterEvent.133302.1": "You and Nazuka sat together in a small boat, drifting across the water.\n\"Look, over there!\"\nA smile appeared on Nazuka's face as she pointed behind you.\nYou turned to see a waterwheel turning steadily along the riverbank.",
    "DatingCharacterEvent.133302.2": "Driven by the flow, the waterwheel creaked and spun.\nNazuka's voice was soft and nostalgic. \"Back in Philae, this was my favorite thing to look at.\"\nWindmills and waterwheels, she mused, were alike—turning endlessly, like the passage of time. Her smile was serene.",
    "DatingCharacterEvent.133302.3": "\"But ... it's not quite the same anymore.\"\n\"Oh?\"\n\"Now that you're here with me, even the most familiar view feels different.\"\nSo you both fell quiet, taking in the scene together.",
    "DatingCharacterEvent.133302.5": "Ever-Turning Waterwheel",
    "DatingCharacterEvent.133302.6": "Visit the Port to unlock",
    "DatingCharacterEvent.133302.7": "You and Nazuka took a small boat out on the water. She noticed a waterwheel turning on the distant shore.\n\nShe said it was always her favorite sight, but now it held new meaning because you were next to her.\n\nYou understood what she meant, and the two of you watched the waterwheel in peaceful silence.",
    "DatingCharacterEvent.134301.1": "You and Fuyuka bumped into the shopkeeper. \"Well, if it isn't Lady Fuyuka! Don't tell me you're on a secret date?\" Fuyuka was so flustered she nearly fainted.",
    "DatingCharacterEvent.134301.2": "With your help, she finally managed to fend off the questioning, but things didn't end there...\n\n\"Lady Fuyuka, how about being our Manager for a Day? I bet the shop would be packed!\"\n\nThe shopkeeper's eager sincerity left Fuyuka with no way to turn the invitation down.",
    "DatingCharacterEvent.134301.3": "Just as the shopkeeper predicted, Fuyuka's popularity drew in a huge crowd. As thanks, the shopkeeper not only doubled the payment but also personally prepared freshly baked cakes for you and Fuyuka.\n\n\"The cake is good. It's all thanks to you, Fuyuka.\"\n\n\"Heh... Hehe, it's only because of your encouragement, Master...\"",
    "DatingCharacterEvent.134301.5": "Manager for a Day",
    "DatingCharacterEvent.134301.6": "Visit the Dessert Shop to unlock",
    "DatingCharacterEvent.134301.7": "You went to the dessert shop with Fuyuka, and the shopkeeper noticed her, so she got roped into being the Manager for a Day.\n\nThe two of you walked away with generous pay and delicious cakes. It was tiring, but sweet in every sense.",
    "DatingCharacterEvent.134302.1": "The cave was growing darker. You could sense Fuyuka's hesitation, so you decided to stop for a while.\n\n\"I... I'm not scared...\"\n\n\"It's fine even if you are,\" you said with a smile.",
    "DatingCharacterEvent.134302.2": "Even with your comfort, a trace of unease still lingered on Fuyuka's face.\n\n\"Master... Are there things you're afraid of too?\"\n\n\"Of course,\" you said. \"But being afraid doesn't mean being cowardly. You're just worried about the dangers ahead, that's why you hesitate, right? Caution is a good thing.\"",
    "DatingCharacterEvent.134302.3": "\"In the end, a hero isn't someone without fear, it's someone who can still step forward to face it when it matters the most.\"\n\n\"T-Then ... if we really run into danger, I'll protect you, Master!\"\n\n\"I know you will.\"\n\nFuyuka finally relaxed, a bright smile spreading across her face.",
    "DatingCharacterEvent.134302.5": "The Brave One's Proposition",
    "DatingCharacterEvent.134302.6": "Visit the Cave to unlock",
    "DatingCharacterEvent.134302.7": "You and Fuyuka ventured into The Cave together. Partway through, she sensed danger ahead and decided to stall for a bit.\n\nWorried that you might think her a coward, she grew uneasy. You saw through it, reassured her, and taught her what courage truly means.\n\nYour words brought her relief and your bond grew a little stronger.",
    ...
    "DatingCharacterEvent.143301.1": "The streets are overflowing with merchandise, yet nothing seems to stop her in her tracks.\nThen you spot a modest sign tucked in an obscure corner: Vintage Shop — Soft Opening.\nFiguring it's worth a shot, you drag her along to see what treasures you can dig up.",
    "DatingCharacterEvent.143301.2": "After winding through a maze of alleys, you finally reach the shop.\n\nIt's a trove of oddities. Just as you're about to dive into the clutter, a rare, sharp gasp comes from behind you.\n\n\"No way... It's real!\"\n\nWraith is holding up a seemingly ordinary pair of nippers, but the blades catch the light with a blinding, razor-sharp glint.",
    "DatingCharacterEvent.143301.3": "\"It's the legendary Godly Hand! The nippers that leave absolutely no stress marks on plastic models!\"\n\nYou have no idea what that means, but she's clearly struck gold.\n\nSeeing her this excited—a rare sight indeed—makes the whole trip worth it.",
    "DatingCharacterEvent.143301.5": "A Rare Find",
    "DatingCharacterEvent.143301.6": "Visit the Market to unlock",
    "DatingCharacterEvent.143301.7": "The market goods were plentiful but uninteresting. So you suggested checking out a new vintage shop instead.\n\nThe real fun of these places lies in the thrill of the hunt. Judging by the results, you both scored big time.",
    "DatingCharacterEvent.143302.1": "Wraith is usually pretty direct, but today she's acting all mysterious as she drags you into a cavern.\n\nThe deeper you go, the chillier it gets, until the sound of running water fills the cave.",
    "DatingCharacterEvent.143302.2": "You thought you hit a dead end at a stone wall, but Wraith flips a hidden switch, and the rock grinds open.\n\nBefore you can react, a natural bathhouse is revealed.\n\n\"I put a lot of work into fixing this place up.\"\n\n\"But seeing that look on your face? Totally worth it.\"\n\n\"Hop in. Don't worry, the water's pristine.\"\n\nShe disappears behind a screen to wash up. Not wanting to be rude, you decide to give this outdoor bath a try. However...",
    "DatingCharacterEvent.143302.3": "\"IT'S FREEZING—!!!\"\n\nYour fingers go numb the second they touch the water. Then it hits you: Wraith loves the cold. That's why she built a private bath here instead of going to the hot springs.\n\n\"So? Pretty nice, right?\"\n\n\"Brr-b-b... Yeah! It's ... g-great!\"\n\nFighting the bone-deep chill, you splash around to fake some enthusiasm.",
    "DatingCharacterEvent.143302.5": "\"Hot\" Springs?",
    "DatingCharacterEvent.143302.6": "Visit the Cave to unlock",
    "DatingCharacterEvent.143302.7": "Wraith led you deep into a cavern to show off a private bathhouse she built herself.\n\nJust as you were getting ready to relax, you realized the water temperature was ... nothing like the hot springs you were expecting.",
    ...
    "DatingCharacterEvent.144301.7": "Talking with Chitose on a small boat near the coast, you realized you still had a long way to go before becoming a true wielder.\n\nThe jade-like blade by her side accompanied her travels, always reflecting back to her a sky veiled in shadows.",
    ...
    "DatingCharacterEvent.158301.1": "You suddenly realize that Laru is in her Snowish Festival outfit, so you ask,\n\n\"Isn't your outfit supposed to be exclusive for Snowish Festival? You're also wearing it now?\"\n\nInstead of giving you an explanation, Laru asks playfully,\n\n\"Why? Do you not like it?\"",
    "DatingCharacterEvent.158301.2": "The market is bustling as always, still brimming with the festive atmosphere of Snowish Festival as decorations hang everywhere.\n\nOut of nowhere, Laru finds a reindeer headband identical to hers.\n\nShe looks at you expectantly, until you finally give in and put it on.",
    "DatingCharacterEvent.158301.3": "\"You know what? We were so busy on Snowish Festival we didn't even take a photo together.\"\n\nLaru suddenly says.\n\n\"Why don't we do it now?\"",
    "DatingCharacterEvent.158301.5": "The Photo",
    "DatingCharacterEvent.158301.6": "Visit the Market to unlock",
    "DatingCharacterEvent.158301.7": "The bustling market is full of fun little items.\n\nLaru says that she forgot to take a photo with you on the Snowish Festival, so she wants to make it up this time.",
    "DatingCharacterEvent.158302.1": "In the dark winter night, the port feels like a wide mouth of the sea.\nBut Laru takes you by your arm excitedly, urging you to move faster while reminding you to watch your steps through the snow.\nLaru seems eager to see something out there in the water.",
    "DatingCharacterEvent.158302.2": "Laru takes you to a platform where ships dock. Under the dim lights, she proudly and confidently tells you something.\n\n\"I had someone in the Trekker Association work it out for me that luminous fish will be riding the current and passing by here tonight. This time, I'll make sure you see fish that actually glow!\"\n\nAs she speaks, she takes out her timekeeping artifact, counting down.",
    "DatingCharacterEvent.158302.3": "You've been standing in the freezing wind for an hour, yet not a single luminous fish has shown up.\n\nLaru frowns, looking a little bit embarrassed.\n\n\"I don't understand. I definitely got the time right ... but where are the fish...?\"",
    "DatingCharacterEvent.158302.5": "Where Are the Fish?",
    "DatingCharacterEvent.158302.6": "Visit the Port to unlock",
    "DatingCharacterEvent.158302.7": "Laru still wants to show you real luminous fish.\n\nShe brings you to the port excitedly after having someone in the Trekker Association work out for her the exact time luminous fish will pass by.\n\nHowever, she forgot to ask about the exact date...",
    "DatingCharacterEvent.159301.1": "You and Coronis venture deeper into the cave. She looks around, as if searching for something. \"Looking for something?\" you have to ask.\n\nHer eyes light up, \"Legend says a lost totem of the Loong ancestors is hidden here.\"",
    "DatingCharacterEvent.159301.2": "\"Loong culture is fascinating,\" she muses. \"Even their totems defy our standard classifications.\"\n\"Is that what we're investigating?\"\nShe doesn't answer. Instead, she beckons you deeper inside.\n\"You'll see soon enough.\"",
    "DatingCharacterEvent.159301.3": "You trail her through the cave for a while, seeing nothing remotely like a totem.\nJust as you open your mouth to ask, she halts.\n\"Get over here. I can't move this by myself. I need you to help transport it.\"\nYou look where she's pointing: a corpse of a boar, completely overgrown with mushrooms.",
    "DatingCharacterEvent.159301.5": "In Search of Totems",
    "DatingCharacterEvent.159301.6": "Visit the Cave to unlock",
    "DatingCharacterEvent.159301.7": "Coronis seemed so fascinated by Loong culture that you assumed she was studying their totems ... or so you thought. Standing before that dead boar, you realize the good doctor will always care more about pathology than anthropology.",
    "DatingCharacterEvent.159302.1": "The Loong market has a vibe all its own. You're happily squatting by a stall, admiring some intricate wooden dolls, when Coronis whispers right into your ear.\n\"The anatomy of this doll... Doesn't it seem incorrect?\"",
    "DatingCharacterEvent.159302.2": "Startled by her voice, you turn to see she's crouched right next to you, scrutinizing the figure in her hand.\n\"Given these proportions, a human subject would be missing two ribs on either side.\"",
    "DatingCharacterEvent.159302.3": "You worry her critique might offend the stall owner, but the middle-aged man's eyes light up with excitement.\n\"You have a sharp eye! I bet you'll appreciate this one.\"\nHe produces a more elaborate doll and pops open its chest, revealing a complete set of internal organs and bones.\nCoronis stares at you, eyes burning with desire. Mesmerized by her gaze, you find yourself paying for the doll without a second thought.",
    "DatingCharacterEvent.159302.5": "A Peculiar Doll",
    "DatingCharacterEvent.159302.6": "Visit the Market to unlock",
    "DatingCharacterEvent.159302.7": "Neither of you expected to find a stall owner at the Loong market who shared such an obsession with human anatomy. The doll is a bit creepy, sure, but Coronis clearly loves it—so you'll count today as a win.",
